...
const reviews = [
	...
	},
	{
		...
		desc: 'Прошла курс',
		type: 'Коммерческая недвижимость',
		text: 'Благодаря этому курсу я освоил новую профессию и теперь уверенно чувствую себя в новой роли. Сертификат, полученный после завершения обучения, стал отличным дополнением к моему резюме. Спасибо за возможность получить качественное образование!',
	},
	{
		id: 3,
		name: 'Алексей М.',
