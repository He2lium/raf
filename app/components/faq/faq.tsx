...
const faqs = [
	{
		...
		answer: [
			...
			'Можете приобрести любую программу на выбор или все сразу. (добавить кнопку “подробнее”, для ссылки на блок с пакетами)',
		],
	},
	{
		id: 2,
	...
	},
	{
		...
		answer: [
			'Стоимость  курса  зависит  от  программы. Мы  рекомендуем  посмотреть  цены  на  сайте  курса  или  связаться  с  организаторами  для  получения  информации. (кнопка “Узнать цену”)',
		],
	},
	{
		id: 4,
